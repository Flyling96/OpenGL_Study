...
void Mesh::Init(VertexData * vertices, unsigned int numVertices, unsigned int* indices, unsigned int numIndices)
{
...
{
	Init(vertices, numVertexData);
}

void Mesh::Init(VertexData * vertices, unsigned int numVertexData)
{
